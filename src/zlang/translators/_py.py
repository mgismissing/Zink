...
class T(Template):
    ...
    def _func_def__new(s):          s.indent += 4;                          return f"def __new__(self{", " if s.n[1] else ""}{s.jwt(s.n[1], ", ")}):{s.body(([f"{" " * s.indent}super().__init__({", ".join(f"{(s.wt(arg)+":").split(":")[0]}={(s.wt(arg)+":").split(":")[0]}" for arg in filter(lambda _: _[0] == "func_assign_super", s.n[1]))})"] if len(list(filter(lambda _: _[0] == "func_assign_super", s.n[1]))) > 0 else [])+[f"{" " * s.indent}self.{(s.wt(arg)+":").split(":")[0]} = {(s.wt(arg)+":").split(":")[0]}" for arg in filter(lambda _: _[0] == "func_assign_self", s.n[1])]+s.wt(s.n[2]))}"
    def _func_def__del(s):          s.indent += 4;                          return f"def __del__(self{", " if s.n[1] else ""}{s.jwt(s.n[1], ", ")}):{s.body(([f"{" " * s.indent}super().__init__({", ".join(f"{(s.wt(arg)+":").split(":")[0]}={(s.wt(arg)+":").split(":")[0]}" for arg in filter(lambda _: _[0] == "func_assign_super", s.n[1]))})"] if len(list(filter(lambda _: _[0] == "func_assign_super", s.n[1]))) > 0 else [])+[f"{" " * s.indent}self.{(s.wt(arg)+":").split(":")[0]} = {(s.wt(arg)+":").split(":")[0]}" for arg in filter(lambda _: _[0] == "func_assign_self", s.n[1])]+s.wt(s.n[2]))}"
    def _func_def__call(s):         s.indent += 4;                          return f"def __call__(self{", " if s.n[1] else ""}{s.jwt(s.n[1], ", ")}):{s.body(([f"{" " * s.indent}super().__init__({", ".join(f"{(s.wt(arg)+":").split(":")[0]}={(s.wt(arg)+":").split(":")[0]}" for arg in filter(lambda _: _[0] == "func_assign_super", s.n[1]))})"] if len(list(filter(lambda _: _[0] == "func_assign_super", s.n[1]))) > 0 else [])+[f"{" " * s.indent}self.{(s.wt(arg)+":").split(":")[0]} = {(s.wt(arg)+":").split(":")[0]}" for arg in filter(lambda _: _[0] == "func_assign_self", s.n[1])]+s.wt(s.n[2]))}"
